...
- **가볍고 설치가 쉬운 버전을 먼저 시도하려면 [v2.0.0-preview.3 WebView2 Native Preview](https://github.com/saveway/codex-usage-monitor/releases/tag/v2.0.0-preview.3)를 사용하십시오.** 약 0.3MB이며 Python, Playwright, Chromium을 포함하지 않고 Microsoft Edge WebView2 Runtime을 사용합니다. 아직 preview이므로 문제가 있으면 v1 Stable을 사용하십시오.
